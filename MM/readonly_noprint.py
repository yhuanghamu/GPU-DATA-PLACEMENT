...
if flag == 1:
 ...
 sys.exit(0)
end1 = time.time()
print (str(end1-start)+ "pure read")
stride.sort(
...
while x<len(stride):
 ...
 if (array == array_next):
  ...
  if(array_size[array]>size_1D*sizeof[array]):
   total_cache_line = 99999999
  print("Array "+str(array)+" put in read only memory has "+str(total_cache_line)+ " cold latency!")
  print("Array "+str(array)+" put in read only memory has "+str(temporal_hit)+" temporal hits")
  print("Array "+str(array)+" put in read only memory has "+str(L1_hit)+" L1 hits")
  print("Array "+str(array)+" put in read only memory has "+str(L2_hit)+" L2 hits")
...
if(array_size[array]>size_1D*sizeof[array]):
 total_cache_line = 99999999 
print("Array "+str(array_next)+" put in read only memory has "+str(total)+ " latency")
print("Array "+str(array_next)+" put in read only memory has "+str(total_cache_line)+ " cold latency")
print("Array "+str(array_next)+" put in read only  memory has "+str(temporal_hit)+ " temporal hits ")
print("Array "+str(array)+" put in read only memory has "+str(L1_hit)+" L1 hits")
print("Array "+str(array)+" put in read only memory has "+str(L2_hit)+" L2 hits")
printout = printout +str(total_cache_line)+" "+str(L1_hit)+" "+str(L2_hit)+"\n"
out = open("output.txt",'a')
