...
if((ty*16+tx)%32<4){
line[yy][0]=0;line[yy][1]=0;line[yy][2]=0;line[yy][3]=(a-aBegin)/aStep;line[yy][4]=ty*16+tx;line[yy][5]=a+ wA * ty + tx;
yy++;
line[yy][0]=0;line[yy][1]=0;line[yy][2]=0;line[yy][3]=(a-aBegin)/aStep;line[yy][4]=ty*16+tx;line[yy][5]=a+ wA * ty + tx;
yy++;}
...
if((ty*16+tx)%32<4){
line[yy][0]=2;line[yy][1]=1;line[yy][2]=0;line[yy][3]=0;line[yy][4]=ty*16+tx;line[yy][5]=c+ wB * ty + tx;
yy++;
}
}
}
