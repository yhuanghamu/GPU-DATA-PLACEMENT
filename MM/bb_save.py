...
def cal_lat(k,state,c,share,total_tem,conten):
 ...
 if j == 0:  #constant
  if p[k][j][0] == 99999999:
   ...
   latency = p[k][j][1]*p[k][j][1]/conten[L1["L1_constant"]]*con_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_constant"]]*con_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_constant"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_constant"]])*con_lat[0]#p[k][j][2]/conten[L1["L1_constant"]]*con_lat[2]+p[k][j][3]/conten[L2["L2_constant"]]*con_lat[1]+(p[k][j][0]-p[k][j][1])*con_lat[2] +(p[k][j][1]-p[k][j][2]/conten[L1["L1_constant"]]-p[k][j][3]/conten[L2["L2_constant"]])*con_lat[0]
   if k!=0:
    latency *=5
   return latency
 if j == 1: #global
  if p[k][j][0] == 99999999:
   ...
   latency =p[k][j][1]* p[k][j][1]/conten[L1["L1_global"]]*glo_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_global"]]*glo_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_global"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_global"]])*glo_lat[0]
   return latency  
 if j == 2 or j ==3:
  if p[k][j][0] == 99999999:
   return(999999999)
  else:
   latency = p[k][j][1]*p[k][j][1]/conten[L1["L1_texture"]]*tex_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_texture"]]*tex_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_texture"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_texture"]])*tex_lat[0]
 ...
 if j == 4: #shared global
  if p[k][j][0] == 99999999:
   ...
   #print(p_shared[k])
   latency = p[k][j][1]*p[k][j][1]/conten[L1["L1_global"]]*glo_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_global"]]*glo_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_global"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_global"]])*glo_lat[0] + p_shared[k]*sh_lat
 ...
 if j == 5 or j ==6:
  if p[k][j][0] == 99999999:
   ...
   latency = p[k][j][1]*p[k][j][1]/conten[L1["L1_texture"]]*tex_lat[2]+p[k][j][2]*p[k][j][2]/conten[L2["L2_texture"]]*tex_lat[1]+(p[k][j][0]-p[k][j][1]*p[k][j][1]/conten[L1["L1_texture"]]-p[k][j][2]*p[k][j][2]/conten[L2["L2_texture"]])*tex_lat[0]+p_shared[k]*sh_lat
   return latency
...
for j in range(0,len(Mem)):
 (lastmin,ls)=first_j(0,j,s,shared_total,0,contension1,state)
 if (min > lastmin):
  min = lastmin
