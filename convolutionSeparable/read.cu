...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = (baseX >= -i * ROWS_BLOCKDIM_X) ? __ldg(&d_Src[i * ROWS_BLOCKDIM_X]) : 0;
    }
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = (imageW - baseX > i * ROWS_BLOCKDIM_X) ? __ldg(&d_Src[i * ROWS_BLOCKDIM_X]) : 0;
    }
