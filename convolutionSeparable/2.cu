...
__constant__ float d_Input[imageW*imageH];
                  // d_Output[imageW*imageH],
                   //d_Buffer[imageW*imageH];
...
)
{
    ...
    //d_Input += baseY * pitch + baseX;
   // d_Buffer += baseY * pitch + baseX;
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = d_Input[i * ROWS_BLOCKDIM_X+baseY * pitch + baseX];
    }
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = (baseX >= -i * ROWS_BLOCKDIM_X) ? d_Input[i * ROWS_BLOCKDIM_X+baseY * pitch + baseX] : 0;
    }
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = (imageW - baseX > i * ROWS_BLOCKDIM_X) ? d_Input[i * ROWS_BLOCKDIM_X+baseY * pitch + baseX] : 0;
    }
...
#pragma unroll
        ...
        d_Dst[i * ROWS_BLOCKDIM_X+baseY * pitch + baseX] = sum;
    }
}
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.x][threadIdx.y + i * COLUMNS_BLOCKDIM_Y] = d_Src[i * COLUMNS_BLOCKDIM_Y * pitch+baseY * pitch + baseX];
    }
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.x][threadIdx.y + i * COLUMNS_BLOCKDIM_Y] = (baseY >= -i * COLUMNS_BLOCKDIM_Y) ? d_Src[i * COLUMNS_BLOCKDIM_Y * pitch+baseY * pitch + baseX] : 0;
    }
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.x][threadIdx.y + i * COLUMNS_BLOCKDIM_Y]= (imageH - baseY > i * COLUMNS_BLOCKDIM_Y) ? d_Src[i * COLUMNS_BLOCKDIM_Y * pitch+baseY * pitch + baseX] : 0;
    }
...
#pragma unroll
        ...
        d_Dst[i * COLUMNS_BLOCKDIM_Y * pitch+baseY * pitch + baseX] = sum;
    }
}
...
int main(int argc, char **argv)
{
    ...
    *h_OutputGPU;
    ...
    cudaMemcpyToSymbol(d_Input, h_Input, imageW * imageH * sizeof(float));
