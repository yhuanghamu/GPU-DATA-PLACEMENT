...
# 6 "vd.cu"
__attribute__((global)) extern void _Z6vecAddPfS_S_(float *, float *, float *);
...
# 262 "/usr/local/cuda-7.0/targets/x86_64-linux/include/math_functions_dbl_ptx3.h" 3
...
# 8 "vd.cu" 2
# 6 "vd.cu"
__attribute__((global)) void _Z6vecAddPfS_S_(
# 6 "vd.cu"
float *a,
# 6 "vd.cu"
float *b,
