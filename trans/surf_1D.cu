...
#define trans_GRID_X 16
#define trans_GRID_Y 16
...
//	}
surf1Dwrite(idata[index_in],surf,index_out*sizeof(float));
	}
}
...
int main(int argc, char **argv) {
 ...
 cudaMallocArray(&B_Array, &forB,trans_size_y*trans_size_x,1,cudaArraySurfaceLoadStore);
...
cudaBindSurfaceToArray(surf,B_Array);
