...
while x<len(stride):
 ...
 if (array == array_next):
  ...
  for i in collect:
   ...
   f.write(str(array)+" "+str(rw_flag)+" 0 0 "+" "+str(collect.index(i))+" "+str(i)+"\n")
  #f.close()
  #s = texture_info
...
for i in collect:
 f.write(str(array_next)+" "+str(rw_flag)+" 0 0 "+" "+str(collect.index(i))+" "+str(i)+"\n")
f.close()
s = texture_info
#exe_command = "./texture.py "+s[1]+" "+s[2]+" "+s[3]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" ldshared.txt"
#os.system(exe_command)
...
out.close()
if dimension[0] == 2:
 exe_command = "./1Dtexture.py "+s[1]+" "+" "+s[3]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" ldshared.txt"
 os.system(exe_command)
 out = open("output.txt",'a')
 out.write("- ")
 out.close()
 exe_command = "./2Dtexture.py "+s[1]+" "+s[2]+" "+s[3]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" "+str(sys.argv[4])#" ldshared.txt"
 os.system(exe_command)
else:
 exe_command = "./1Dtexture.py "+s[1]+" "+" "+s[3]+" "+s[4]+" "+s[5]+" "+s[6]+" "+s[7]+" "+s[8]+" "+s[9]+" ldshared.txt"
