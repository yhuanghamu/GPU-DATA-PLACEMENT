...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = tex1Dfetch(texRef,baseX+i*ROWS_BLOCKDIM_X+baseY*pitch);//d_Src[i * ROWS_BLOCKDIM_X];
    }
...
#pragma unroll
    ...
    {
        s_Data[threadIdx.y][threadIdx.x + i * ROWS_BLOCKDIM_X] = (baseX >= -i * ROWS_BLOCKDIM_X) ? tex1Dfetch(texRef,baseX+i*ROWS_BLOCKDIM_X+baseY*pitch):0;//d_Src[i * ROWS_BLOCKDIM_X] : 0;
    }
