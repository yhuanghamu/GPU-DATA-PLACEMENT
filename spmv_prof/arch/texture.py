...
for line in open(sys.argv[10],'r'):
 ...
 if thread[0].isdigit():
  ...
  if thread[0] == "dimension":
   ...
   continue
if dimension[0] == 1:
 exe_command = "./1Dtexture.py "+sys.argv[1]+" "+sys.argv[3]+" "+sys.argv[4]+" "+sys.argv[5]+" "+sys.argv[6]+" "+sys.argv[7]+" "+sys.argv[8]+" "+sys.argv[9]+" "+sys.argv[10]
 os.system(exe_command)
elif dimension[0] == 2:
 exe_command = "./1Dtexture.py "+sys.argv[1]+" "+sys.argv[3]+" "+sys.argv[4]+" "+sys.argv[5]+" "+sys.argv[6]+" "+sys.argv[7]+" "+sys.argv[8]+" "+sys.argv[9]+" "+sys.argv[10]
 os.system(exe_command)
 exe_command = "./2Dtexture.py "+sys.argv[1]+" "+sys.argv[2]+" "+sys.argv[3]+" "+sys.argv[4]+" "+sys.argv[5]+" "+sys.argv[6]+" "+sys.argv[7]+" "+sys.argv[8]+" "+sys.argv[9]+" "+sys.argv[10]
 os.system(exe_command)
